...
(function (a) {
  function k(a, b, c, d) {
    ...
    var c,
        d = 0,
        e = "";while (c = a.substr(d).match(/[^\w\d\- %@&]*\*[^\w\d\- %@&]*/)) {
      d = c.index + c[0].length, c[0] = c[0].replace(/^\*/, "([_.()!\\ %@&a-zA-Z0-9-]+)"), e += a.substr(0, c.index) + c[0];
    }a = e += a.substr(d);var f = a.match(/:([^\/]+)/ig),
        g,
        h;if (f) {
      h = f.length;for (var j = 0; j < h; j++) {
    ...
    if (!a.length) return c();var d = 0;(function e() {
      b(a[d], function (b) {
        b || b === !1 ? (c(b), c = function c() {}) : (d += 1, d === a.length ? c() : e());
      });
    })();
  }function g(a) {
    ...
    return b.hash === "" || b.hash === "#";
      ...
      d = { mode: "modern", hash: b.hash, history: !1, check: function check() {
      ...
      if (!!e && !!e.listeners) {
        var b = e.listeners;for (var c = b.length - 1; c >= 0; c--) {
          b[c] === a && b.splice(c, 1);
        }
      }
    ...
    }, writeFrame: function writeFrame(a) {
    ...
    a = a || {};for (var b = 0; b < this.methods.length; b++) {
    ...
    var d = this,
        _e2;this.async ? (_e2 = function e(c, d) {
      if (Array.isArray(c)) return h(c, _e2, d);typeof c == "function" && c.apply(b, (a.captures || []).concat(d));
    }, h(a, _e2, function () {
      c && c.apply(b, arguments);
    })) : (_e2 = function _e(c) {
      if (Array.isArray(c)) return f(c, _e2);if (typeof c == "function") return c.apply(b, a.captures || []);typeof c == "string" && d.resource && d.resource[c].apply(b, a.captures || []);
    }, f(a, _e2));
    ...
    function l(a) {
      function c(a) {
        ...
        var c = [];for (var d = 0; d < a.length; d++) {
      ...
      if (c.hasOwnProperty(m) && (!this._methods[m] || this._methods[m] && _typeof(c[m]) == "object" && !Array.isArray(c[m]))) {
    ...
    var e, f, g, h, i;b = b.filter(function (a) {
      ...
      if (!!i || !!b.length || d !== this.routes) {
        f = _typeof(d[i]), g = Array.isArray(d[i]);if (d[i] && !g && f == "object") {
          e = _typeof(d[i][a]);switch (e) {case "function":
      ...
      }e = _typeof(d[a]);switch (e) {case "function":
    ...
    function d(b, d) {
      ...
      var c = this;b = b || [], Array.isArray(b) || (b = b.split(c.delimiter));for (var e in a) {
        a.hasOwnProperty(e) && d(e, b.slice(0));
      }
    }
  };
})((typeof exports === "undefined" ? "undefined" : _typeof(exports)) == "object" ? exports : window);